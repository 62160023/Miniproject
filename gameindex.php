            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <h5 class="col-md-6 text-center">
                        ...
                        <a href="game_mynote_insert.php" class="fas fa-plus-square col-md-3 text-center" style="font-size: 2.5em; "></a>
                </div>
            </div>
                    ...
                    <?php 
                        ...
                        // output data of each row
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo '<a href="game_mynote_edit.php?number=' . $row['number'] . '" class="fas fa-edit col-md-3 text-center" style="font-size: 2.5em;"></a>';
                                echo "</div></div>";
                                echo '<!-- Modal -->
